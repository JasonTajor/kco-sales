 ...
 *
 * Inlined as SVG rather than loaded from a CDN so the sign-in button paints
 * with the rest of the page and works offline. The colours are Google's own
 * brand values and must not be re-tinted - the mark is only permitted on a
 * light or white surface, which is why the button behind it is `secondary`.
 */
